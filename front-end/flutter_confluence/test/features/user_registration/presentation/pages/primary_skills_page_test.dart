...
import 'package:flutter_confluence/features/user_registration/presentation/pages/primary_skills_page.dart';
...
void main() {
  testWidgets('Primary Skills Page should show expected widgets', (tester) async {
    ...
    // act
    await tester.pumpWidget(MaterialApp(theme: Themes.appTheme, home: PrimarySkillsPage(navParameters: navParameters)));
